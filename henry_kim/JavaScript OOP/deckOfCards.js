...
class Card {
  constructor(value,suit){
    ...
    //value = index; this would literaly correlate the value to the card (1-13)
    this.value = value;
    //value "j" is the index so 1 is subtracted; also 1 is subtracted to match the physical value of the card
